...
export default function Discover({ dictionary, lang }: DiscoverProps) {
  return (
    <section className="relative mx-auto max-w-[1200px] px-4 py-20 max-2xl:overflow-hidden">
      ...
      <div className="grid grid-cols-3 gap-6 max-lg:grid-cols-2">
        {discoverLinks.map((link) => (
          ...
          >
            ...
            <div className="absolute bottom-5 left-5 z-30 flex items-center justify-center bg-background-50 text-lg transition-all duration-300 max-md:bottom-0 max-md:left-0 max-md:w-full max-md:text-sm">
      ...
      <div className="absolute bottom-0 left-0 -z-10 h-full w-full rotate-6 scale-50 rounded-lg bg-blue-200 dark:bg-base-100 blur-[550px]" />
