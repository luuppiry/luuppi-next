      ...
      <div className="card card-body mb-6">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="join w-full sm:w-auto">
            <div className="join-item inline-flex h-12 items-center border border-r-0 bg-secondary-400 px-3 dark:border-[var(--fallback-bc,oklch(var(--bc)/.2))] dark:bg-[var(--fallback-b1,oklch(var(--b1)/var(--tw-bg-opacity)))]">
