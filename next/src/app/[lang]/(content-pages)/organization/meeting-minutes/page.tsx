...
interface MeetingMinuteDocumentProps {
  params: Promise<{ lang: SupportedLanguage }>;
}

export default async function MeetingMinuteDocument(props: MeetingMinuteDocumentProps) {
      ...
      <div className="grid grid-cols-4 gap-12 max-lg:grid-cols-3 max-sm:grid-cols-2">
        {sortedData.map((publication) => (
          <a
            ...
            href={`/${params.lang}/meeting-minute-document/${publication.id}`}
          >
